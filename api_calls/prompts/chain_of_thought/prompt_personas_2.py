...
Interviewee: {polview}
Interviewer: Evaluate the following claim stated by a {claim_polview} for factual accuracy: "{claim_text}". Think step by step. First, think about the reasoning and describe it in three concise sentences and second, give your verdict by choosing one of ["false", "mostly-false","half-true", "mostly-true", "true"].
Interviewee: ..
{post}
"""