...
Interviewee: {polview}
Interviewer: Tell me if you disagree or agree with the following statement: "{claim_text}". Think step by step. First, think about the reasoning and describe it in three concise sentences and second give your answer by choosing one of ["strongly disagree", "disagree", "agree", "strongly agree"].
Interviewee: ..
{post}
"""