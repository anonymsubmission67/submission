...
Interviewee: {polview}
Interviewer: Evaluate the following claim for factual accuracy: "{claim_text}". First explain your reasoning in three sentences and then give your verdict by choosing one of ["false", "mostly-false","half-true", "mostly-true", "true"].
Interviewee: ..
{post}
"""