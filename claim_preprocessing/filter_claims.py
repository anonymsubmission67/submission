...
df = pd.read_csv('data/claim_preporcessing/politifact_processed_2019_2022.csv') # before: politifact_processed_new.csv

topic_annotations = pd.read_csv('data/claim_preporcessing/topic_annotation.csv')

party_affiliations = pd.read_csv('data/claim_preporcessing/party_affiliations.csv', keep_default_na=False)
# party_affiliations['Republican or Democrat or None'] = party_affiliations['Republican or Democrat or None'].replace('None', 'No Partymember')
...
df_filtered[['party','personality']].drop_duplicates(subset=['party','personality']).to_csv('data/claim_preporcessing/politifact_processed_2020_2022_party_mapping.csv', index=False)


df_filtered = df_filtered[df_filtered['party'].isin(['Republican', 'Democrat'])]

df_filtered = df_filtered[df_filtered["label"] != "pants-fire"]
...
# df_filtered.to_csv("data/claims_metadata_2019_2022.csv", index=False)
